...
<body class="font-[Poppins] bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    ...
    <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      <div class="overflow-hidden rounded-lg">
        ...
        <img
          ...
          src="img/futsal.jpg"
          alt="FUTSAL"
          data-description="Kegiatan Clasmeet fustal yang di adakan setiap tahun nya setelah ujian semester,XI PPLG 1 mengikuti kegiatan tersebut untuk meramaikannya"
        />
      </div>
      <div class="overflow-hidden rounded-lg">
        ...
        <img
          ...
          data-description="Kunjungan industri ke PT NETKROM untuk mempelajari bagaimana kita membuat website e-commerce dan lain lain, dan memperkenalkan PT mereka yang berfungsi untuk kegiatan kesehatan."
        />
      </div>
      <div class="overflow-hidden rounded-lg">
        ...
        <img
          ...
          src="img/itb.jpg"
          alt="Kunjungan ITB"
          data-description="Kunjungan ke Institut Teknologi Bandung Jatinangor, disitu kami dikenalkan sejarah tentang bagaimana ITB bisa tercipta, lalu kita diberikan pengalaman bagaimana agar kita bisa masuk kuliah dengan PTN."
        />
      </div>
    </div>
  </div>
  ...
  >
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-md text-center">
      <p id="popup-description" class="text-gray-800 text-lg mb-6"></p>
      <button
        id="close-modal"
  ...
  <div class="max-w-6xl mx-auto px-4 py-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <!-- Media Sosial -->
      <div>
        <h3 class="text-white text-sm font-semibold mb-2">Media Sosial</h3>
      ...
      <!-- Tautan -->
      <div>
        <h3 class="text-white text-sm font-semibold mb-2">Tautan</h3>
        <ul class="space-y-1">
          <li><a href="#" class="text-gray-400 hover:text-white text-sm">Beranda</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white text-sm">Profil Kelas</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white text-sm">Jadwal</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white text-sm">Galeri</a></li>
        </ul>
      </div>

      <!-- Lokasi -->
      <div>
        <h3 class="text-white text-sm font-semibold mb-2">Lokasi</h3>
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126899.6371755187!2d106.76078954645227!3d-6.390356116798725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ebd2b6cb7471%3A0x8655c8ad5c4cf524!2sSMK%20Citra%20Negara%20Depok!5e0!3m2!1sen!2sid!4v1610984549930!5m2!1sen!2sid" 
          width="100%" 
          height="120" 
          style="border:0;" 
          allowfullscreen="" 
